...
//   console.log();
//   console.log(invoiceCustomSettings.letterHeadImg);
//   console.log(invoiceCustomSettings.signatureImg);

//   const handelCreateInvoice = (e: React.FormEvent) => {
//     e.preventDefault();
...
//         </p>
//         <form onSubmit={handelCreateInvoice}>
//           <div>
...
//           </div>
//           <div>
//             <h4 className="text-sm font-semibold text-accent uppercase tracking-wide mb-3 mt-3">
//               Images
//             </h4>
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
